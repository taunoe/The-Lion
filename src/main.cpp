 ...
 * Author:  Tauno Erik 
 * 
 * TK/MOSI - GP19 Master Out Slave In (data output from master)
 * RX/MISO - GP16 Master In Slave Out (data output from slave)
 * SCK     - GP18 Serial Clock (output from master)
 * CSn/SS  - GP17 Chip/Slave Select (often active low, output from master to indicate that data is being sent)
 */
...
#define CLK_PIN   p18  // or SCK - CLK
#define DATA_PIN  p19  // or MOSI - DIN
#define CS_PIN    p17  // or SS - CS
